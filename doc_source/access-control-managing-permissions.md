...
This role provides AWS Control Tower with access to infrastructure critical to maintaining the landing zone\.
The role requires both a inline policy, and managed policy attachment\.
